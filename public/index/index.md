...
{% note warning %}
<i class="fas fa-cog fa-spin"></i> Brdgメールのセキュリティ問題が解決不可能なので，現在brdgメールサーバーを廃棄する方向でうごいています。
{% endnote %}
...
- <i class="far fa-folder-open"></i> [ファイル共有システムOMU](https://webdav.ecs.osaka-cu.ac.jp/proself/) ☞ 使い方はこちら
