...
- 「共有76 license」「共有120 license」のフォルダでしか解析を流さない．（流す状況の見早いところ：\\NAS_sy21\common\Abaqus_Run）  
- 同時に使用できるフォルダは一つまで（同じフォルダであれば，連続で流してOK）
- 解析を流し終えたら，上記フォルダ内の出力ファイルを消去する． 
- inpファイルの名前は，job3など，初期設定にせず，必ず名前を付ける（他の人と区別するため）．
      　　　　　　　　　更新日：2022/12/01  
